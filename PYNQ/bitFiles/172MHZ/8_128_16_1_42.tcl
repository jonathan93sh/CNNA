...
proc create_root_design { parentCell } {
  ...
  set cnn_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:cnn:456.122 cnn_0 ]
  set_property -dict [ list \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRL_APB__IOU_SWITCH_CTRL__ACT_FREQMHZ {258.330750} \
   ...
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__ACT_FREQMHZ {172.220505} \
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__DIVISOR0 {6} \
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__DIVISOR1 {1} \
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__FREQMHZ {173} \
   ...
   CONFIG.PSU__CRL_APB__RPLL_CTRL__FBDIV {62} \
