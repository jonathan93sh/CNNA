...
module cnn_M_AXIS_DATA_if (
    ...
    // User signals
    input  wire [63:0] data_source_0_din,
    ...
    input  wire [7:0]  data_source_2_din,
...
module cnn_M_AXIS_DATA_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
