...
architecture behav of cnn_thread_cnn_stream_sink is 
    ...
    signal p_08_0_reg_2532 : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000000000000000";
...
begin
    ...
    p_08_0_reg_2532_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                p_08_0_reg_2532 <= ap_const_lv32_0;
            else
                if ((not(((io_acc_block_signal_op1963 = ap_const_logic_0) or (io_acc_block_signal_op1959 = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
                    p_08_0_reg_2532 <= count_fu_2558_p2;
    ...
    count_fu_2558_p2 <= std_logic_vector(unsigned(p_08_0_reg_2532) + unsigned(ap_const_lv32_1));
    ...
    data_sink_0_read_assign_proc : process(ap_CS_fsm_state2, io_acc_block_signal_op1959, io_acc_block_signal_op1963)
    begin
        if ((not(((io_acc_block_signal_op1963 = ap_const_logic_0) or (io_acc_block_signal_op1959 = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    data_sink_1_read_assign_proc : process(ap_CS_fsm_state2, io_acc_block_signal_op1959, io_acc_block_signal_op1963)
    begin
        if ((not(((io_acc_block_signal_op1963 = ap_const_logic_0) or (io_acc_block_signal_op1959 = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    data_sink_2_read_assign_proc : process(ap_CS_fsm_state2, io_acc_block_signal_op1959, io_acc_block_signal_op1963)
    begin
        if ((not(((io_acc_block_signal_op1963 = ap_const_logic_0) or (io_acc_block_signal_op1959 = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    io_acc_block_signal_op1959 <= (data_sink_2_empty_n and data_sink_1_empty_n and data_sink_0_empty_n);
    io_acc_block_signal_op1963 <= (sc_fifo_chn_5_full_n and sc_fifo_chn_4_full_n and sc_fifo_chn_3_full_n);
    r1_dma_egress_status <= std_logic_vector(unsigned(p_08_0_reg_2532) + unsigned(ap_const_lv32_1));

    r1_dma_egress_status_ap_vld_assign_proc : process(ap_CS_fsm_state2, io_acc_block_signal_op1959, io_acc_block_signal_op1963)
    begin
        if ((not(((io_acc_block_signal_op1963 = ap_const_logic_0) or (io_acc_block_signal_op1959 = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            r1_dma_egress_status_ap_vld <= ap_const_logic_1;
        else 
            r1_dma_egress_status_ap_vld <= ap_const_logic_0;
        end if; 
    end process;
    ...
    sc_fifo_chn_3_write_assign_proc : process(ap_CS_fsm_state2, io_acc_block_signal_op1959, io_acc_block_signal_op1963)
    begin
        if ((not(((io_acc_block_signal_op1963 = ap_const_logic_0) or (io_acc_block_signal_op1959 = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    sc_fifo_chn_4_write_assign_proc : process(ap_CS_fsm_state2, io_acc_block_signal_op1959, io_acc_block_signal_op1963)
    begin
        if ((not(((io_acc_block_signal_op1963 = ap_const_logic_0) or (io_acc_block_signal_op1959 = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    sc_fifo_chn_5_write_assign_proc : process(ap_CS_fsm_state2, io_acc_block_signal_op1959, io_acc_block_signal_op1963)
    begin
        if ((not(((io_acc_block_signal_op1963 = ap_const_logic_0) or (io_acc_block_signal_op1959 = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
